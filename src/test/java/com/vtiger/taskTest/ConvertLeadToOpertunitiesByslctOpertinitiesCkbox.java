...
public class ConvertLeadToOpertunitiesByslctOpertinitiesCkbox {
	...
	public static void main(String[] args) throws IOException {
		// Converting  external file in to java readable format
				...
				driver.findElement(By.xpath("//input[@id='select_account']")).click();//org
				driver.findElement(By.xpath("//input[@id='select_potential']")).click();//opp only select
				driver.findElement(By.xpath("//input[@id='select_contact']")).click();//contact
				
				
				WebElement text = driver.findElement(By.xpath("//select[@name='sales_stage']"));
				WebDriverUtility.dropDownHandlebyVisibleText(text,"Qualification" );
